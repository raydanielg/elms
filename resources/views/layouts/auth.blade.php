...
<body class="font-['Nunito',sans-serif] antialiased text-[#1C1B1B] min-h-screen bg-[#F7F4F1]">
    ...
    <div class="fixed inset-0 z-0">
        ...
        <div class="absolute inset-0 opacity-30" style="background-image: radial-gradient(circle at 20% 50%, rgba(246,137,31,0.15) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(124,21,40,0.2) 0%, transparent 50%);"></div>
    </div>
