...
@section('title', 'Login - ' . config('app.name', 'ELMS'))
...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-maroon-600 to-maroon-700 px-8 py-8 text-center">
            <div class="w-16 h-16 mx-auto bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-4">
                <svg class="w-8 h-8 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/></svg>
            </div>
            <h2 class="text-2xl font-extrabold text-white">Welcome Back</h2>
            <p class="text-maroon-100 text-sm mt-1">Sign in to your {{ config('app.name', 'ELMS') }} account</p>
        </div>
        ...
        <div class="p-8">
            ...
            @if (Route::has('register'))
                ...
                <p class="text-center text-sm text-gray-500">
                    ...
                    <a href="{{ route('register') }}" class="font-semibold text-maroon-600 hover:text-maroon-700 transition-colors">Create one</a>
                </p>
            @endif
        </div>
    </div>
    ...
    {{-- Footer --}}
    <p class="mt-6 text-center text-xs text-gray-400">&copy; {{ date('Y') }} {{ config('app.name', 'ELMS') }}. All rights reserved.</p>
</div>
@endsection
